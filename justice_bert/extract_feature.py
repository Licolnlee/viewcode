...
class InputFeatures(object):    # 输入特征
...
class BertVector:   # BERT向量
    ...
    def __init__(self, batch_size=32):
        ...
        """
        self.max_seq_length = args.max_seq_len  # 最大序列长度
        self.layer_indexes = args.layer_indexes     # 句向量
        self.gpu_memory_fraction = 1    # GPU使用率
        if os.path.exists(args.graph_file):     # 存在graph
