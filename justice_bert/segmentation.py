...
import justice_bert.seg_util as seg_util
...
class WordSegmentation(object):
    ...
    def __init__(self, stop_words_file = None, allow_speech_tags = seg_util.allow_speech_tags):
        """
        Keyword arguments:
        ...
        allow_speech_tags = [seg_util.as_text(item) for item in allow_speech_tags]
...
class SentenceSegmentation(object):
    ...
    def __init__(self, delimiters=seg_util.sentence_delimiters):
        """
        Keyword arguments:
        delimiters -- 可迭代对象，用来拆分句子
        """
        self.delimiters = set([seg_util.as_text(item) for item in delimiters])
    
    def segment(self, text):
        res = [seg_util.as_text(text)]
        
        seg_util.debug(res)
        seg_util.debug(self.delimiters)
...
class Segmentation(object):
    ...
    def __init__(self, stop_words_file = None, 
                    allow_speech_tags = seg_util.allow_speech_tags,
                    delimiters = seg_util.sentence_delimiters):
        """
        Keyword arguments:
